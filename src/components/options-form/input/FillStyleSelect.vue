...
import { FillStyle } from '@image-tracer-ts/core'
...
const itemsFillStyle = [
    ...
    {
        title: 'Stroke & Fill',
        value: FillStyle.STROKE_FILL,
        description: 'Add additional outline to fully colored shapes.',
    },
...
const inputConfig = useInputConfig(toRef(props, 'showHelp'), {
    description,
    tableData: { data: itemsFillStyle, keys: { title: 'Option', description: 'Description' } },
})
</script>
