...
const description = 'Further brighten colors by removing transparency. If opacity of a color is above the given threshold, it will be changed to full opacity. Values are between 0 (all colors become fully opaque) and 1 (no change).'
