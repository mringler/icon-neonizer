...
const description =
    'Maximum allowed change to pixel value through blur. If blurred pixel value exceeds delta, the original pixel is restored. Values are between 0 (no change) and 1020 (255 for each channel - any change is fine).'
