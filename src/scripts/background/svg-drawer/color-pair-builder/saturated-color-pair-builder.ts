...
import type { ColorPairBuilder } from "./color-pair-builder";


export class SaturatedColorPairBuilder implements ColorPairBuilder {
    ...
    protected generateSaturatedPair(hsvColor: HSV): [RgbColor, RgbColor] {
        ...
        return [
            this.hsvToRgb(hsvColor),
            this.hsvToRgb(shiftedColor)
        ];
    }
}